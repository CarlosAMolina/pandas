...
values_and_is_duplicated_series = users_df.groupby(by=["id", "id_new"])["age"].count() > 1
print("users_df")
print(users_df)
...
condition_is_duplicated = [value is np.True_ for value in values_and_is_duplicated_series.values]
...
duplicated_records_b = values_and_is_duplicated_series[values_and_is_duplicated_series.values == True].keys()
